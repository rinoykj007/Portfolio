  ...
  return (
    <header className="container mx-auto md:flex justify-between py-2 max-width">
      <div className="flex justify-between items-center py-2 md:py-10">
        ...
        <div onClick={toggleClass} className="cursor-pointer" style={{backgroundColor:"black"}}>
        <svg
    className="stroke-dark-heading dark:stroke-black background-color: black md:hidden"
    width="25"
    height="20"
    viewBox="0 0 16 13"
    fill="none"
